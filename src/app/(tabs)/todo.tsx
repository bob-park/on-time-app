  ...
  return (
    <View className="flex-1 bg-gray-50 pt-[68px] dark:bg-gray-950">
      ...
      <View className="flex-1 items-center justify-center gap-4 px-8 pb-24">
        <View className="size-16 items-center justify-center rounded-full bg-gray-100 dark:bg-gray-800">
        ...
        <Pressable className="mt-3 rounded-2xl bg-blue-500 px-6 py-3.5">
